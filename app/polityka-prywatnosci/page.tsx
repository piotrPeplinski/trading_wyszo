...
export const metadata: Metadata = {
  title: "Polityka prywatności — JWFOREX",
  description: "Polityka prywatności serwisu jwforex.pl.",
};
  ...
  return (
    <LegalPage title="Polityka prywatności">
      <section className="flex flex-col gap-3">
        ...
        <ul>
          <li>Niniejsza polityka dotyczy Serwisu www, funkcjonującego pod adresem url: https://jwforex.pl/</li>
          <li>
            Operatorem serwisu oraz Administratorem danych osobowych jest: NOWA MENTALNOŚĆ
            SPÓŁKA Z OGRANICZONĄ ODPOWIEDZIALNOŚCIĄ, REGON 525389477, NIP 7812051468, KRS
            0001038074, ul. Letnia 28/2, Kiekrz 62-090.
          </li>
          <li>Adres kontaktowy poczty elektronicznej operatora: jwforex11@gmail.pl</li>
      ...
      <section className="flex flex-col gap-3">
        ...
        <ul>
          ...
          <li>
            ...
            posiadający Operator klucz może je odczytać. Dzięki temu dane są chronione na
      ...
      <section className="flex flex-col gap-3">
        <h2>3. Hosting</h2>
        <p>Serwis jest hostowany (technicznie utrzymywany) na serwerach operatora: jdm.pl</p>
      </section>
      ...
      <section className="flex flex-col gap-3">
        ...
        <ul>
          ...
          <li>
            Przysługuje Ci prawo do złożenia sprzeciwu w zakresie przetwarzania danych osobowych
            w celu wykonania prawnie uzasadnionych interesów realizowanych przez Administratora,
          ...
          <li>
            Dane osobowe nie są przekazywane do krajów trzecich w rozumieniu przepisów o ochronie
      ...
      <section className="flex flex-col gap-3">
        ...
        <p>
          Informacje o zachowaniu użytkowników w serwisie mogą podlegać logowaniu. Dane te są
      ...
      <section className="flex flex-col gap-3">
        ...
        <ul>
          <li>
            ...
            (Google Inc. z siedzibą w USA). Operator nie przekazuje operatorowi tej usługi danych
          ...
          <li>
            ...
            dochodzi do przekazania żadnych danych osobowych od Operatora do operatorów reklam.
      ...
      <section className="flex flex-col gap-3">
        ...
        <ul>
          ...
          <li>
            ...
            <ul>
              <li>
                <a href="https://support.microsoft.com/pl-pl/help/10607/microsoft-edge-view-delete-browser-history" target="_blank" rel="noopener noreferrer">Edge</a>
              </li>
              <li>
                <a href="https://support.microsoft.com/pl-pl/help/278835/how-to-delete-cookie-files-in-internet-explorer" target="_blank" rel="noopener noreferrer">Internet Explorer</a>
              </li>
              <li>
                <a href="https://support.google.com/chrome/bin/answer.py?hl=pl&answer=95647" target="_blank" rel="noopener noreferrer">Chrome</a>
              </li>
              <li>
                <a href="https://support.apple.com/kb/PH5042" target="_blank" rel="noopener noreferrer">Safari</a>
              </li>
              <li>
                <a href="https://support.mozilla.org/pl/kb/W%C5%82%C4%85czanie%20i%20wy%C5%82%C4%85czanie%20obs%C5%82ugi%20ciasteczek" target="_blank" rel="noopener noreferrer">Firefox</a>
              </li>
              <li>
                <a href="https://help.opera.com/Windows/12.10/pl/cookies.html" target="_blank" rel="noopener noreferrer">Opera</a>
              </li>
            </ul>
          </li>
        </ul>
        ...
        <ul>
          <li>
            <a href="https://support.google.com/chrome/bin/answer.py?hl=pl&answer=95647" target="_blank" rel="noopener noreferrer">Android</a>
          </li>
          <li>
            <a href="https://support.apple.com/kb/HT1677?viewlocale=pl_PL" target="_blank" rel="noopener noreferrer">Safari (iOS)</a>
          </li>
          <li>
            <a href="https://www.windowsphone.com/pl-pl/how-to/wp7/web/changing-privacy-and-other-browser-settings" target="_blank" rel="noopener noreferrer">Windows Phone</a>
          </li>
        </ul>
      </section>
    </LegalPage>
